...
async function buildExtension(target, files) {
    const entries = {
        "dist/MallCord.js": await readFile("dist/browser/extension.js"),
        "dist/MallCord.css": await readFile("dist/browser/extension.css"),
...
const appendCssRuntime = readFile("dist/MallCord.user.css", "utf-8").then(content => {
    const cssRuntime = `unsafeWindow._vcUserScriptRendererCss=\`${content.replaceAll("`", "\\`")}\``;

    return appendFile("dist/MallCord.user.js", cssRuntime);
});
