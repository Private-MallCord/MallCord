...
**MallCord** is a vaporwave-inspired Discord client mod by **Sonny (sonnyasd)**. It is a rebrand and reskin of
...
**Windows** — 
```sh
irm "https://raw.githubusercontent.com/Sonnyasd/MallCord/main/misc/install.bat" -OutFile install.bat; .\install.bat
```
