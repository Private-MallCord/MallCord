...
function patchBadges() {
    ...
    if (typeof BadgeAPIPlugin?.getMallCordDonorBadges !== "function") return;
    badgesPatched = true;
    originalGetTestcordCustomBadges = BadgeAPIPlugin.getMallCordDonorBadges.bind(BadgeAPIPlugin);
    BadgeAPIPlugin.getMallCordDonorBadges = function (userId: string) {
...
function unpatchBadges() {
    if (!badgesPatched) return;
    if (originalGetTestcordCustomBadges) BadgeAPIPlugin.getMallCordDonorBadges = originalGetTestcordCustomBadges;
    badgesPatched = false;
}
...
export default definePlugin({
    ...
    authors: [MallCordDevs.SirPhantom89],
