...
const MallCordIcon = (props: React.PropsWithChildren<SVGProps<SVGSVGElement>>) => (
    ...
    >
        ...
        <path d="M470.711 406.73C493.342 393.132 522.712 400.455 536.311 423.086C549.909 445.718 542.587 475.088 519.955 488.687L253.783 648.619L204.538 566.663L470.711 406.73Z" />
    </svg>
);
