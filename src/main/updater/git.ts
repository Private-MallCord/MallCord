...
const MALLCORD_DIR = join(__dirname, "../../");
...
async function getRepo() {
    return "https://github.com/Sonnyasd/MallCord";
}
...
async function pull() {
    try {
        ...
        return res.stdout.includes("Fast-forward") || res.stdout.includes("Already up to date");
    } catch {
        return false;
    }
}
