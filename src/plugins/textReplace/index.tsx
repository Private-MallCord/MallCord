...
import { Devs, MallCordDevs, SUPPORT_CHANNEL_IDS } from "@utils/constants";
...
const TEXT_REPLACE_RULES_EXEMPT_CHANNEL_IDS = [
    ...
    "1419347113745059961", // MallCord's Requests Channel
    ...SUPPORT_CHANNEL_IDS
];
...
export default definePlugin({
    ...
    authors: [Devs.AutumnVN, Devs.TheKodeToad, MallCordDevs.Etorix, MallCordDevs.Ape],
    isModified: true,
    settings,
